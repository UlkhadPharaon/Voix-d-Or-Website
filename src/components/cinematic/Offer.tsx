        ...
        <section id="offer" className="py-24 px-6 bg-[#050505] relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-5xl text-white font-display font-normal mb-6">
                    ...
                    {PACK_ITEMS.map((item, idx) => (
                        ...
                        >
                            <GlowCard
                                glowColor="gold"
                                customSize
                                className="h-full p-10 group cursor-default"
                            >
                                <div className="flex items-start gap-6">
                                    <div className="text-[#D4AF37] opacity-60 group-hover:opacity-100 group-hover:scale-110 transition-all duration-500 shrink-0 mt-1">
                                        <item.icon size={24} strokeWidth={1} />
                                    </div>
                                    <div>
                                        <h3 className="text-xl text-white mb-3 group-hover:text-[#D4AF37] transition-colors font-display tracking-wide">
                                            {item.title}
                                        </h3>
                                        <p className="text-gray-500 text-sm leading-7 font-light font-satoshi">
                                            {item.desc}
                                        </p>
                                    </div>
                                </div>
                ...
                <div className="border-t border-[#D4AF37]/10 pt-16">
                    <div className="text-center mb-12">
                        <h3 className="text-2xl text-white font-display mb-2">L'ART DE LA DIFFÉRENCE</h3>
                    </div>
                        ...
                        {ADVANTAGES.map((adv, idx) => (
                            ...
                            >
                                <GlowCard
                                    glowColor="gold"
                                    customSize
                                    className="h-full flex flex-col items-center text-center p-8 group cursor-default text-white bg-transparent"
                                >
                                    ...
                                    <p className="text-gray-500 text-sm font-light leading-6 font-satoshi">
                                        {adv.desc}
                                    </p>
                                </GlowCard>
                            </motion.div>
