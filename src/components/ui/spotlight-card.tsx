...
const GlowCard: React.FC<GlowCardProps> = ({
  ...
  const getInlineStyles = () => {
    const baseStyles: React.CSSProperties & Record<string, string | number> = {
      ...
      '--radius': '14',
      '--border': '1',
      '--backdrop': theme === 'light' ? 'rgba(255, 255, 255, 0.4)' : 'hsl(0 0% 60% / 0.05)',
  ...
  return (
    <>
      ...
      <div ref={cardRef} data-glow style={getInlineStyles()} className={`${getSizeClasses()} ${!customSize ? 'aspect-[3/4] p-8 gap-4 flex flex-col' : ''} rounded-2xl relative shadow-sm backdrop-blur-md ${className}`}>
