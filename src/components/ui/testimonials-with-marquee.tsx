        ...
        <section className={cn(
            ...
            <div className="mx-auto flex max-w-[1280px] flex-col items-center gap-4 text-center sm:gap-16">
                <div className="flex flex-col items-center gap-4 px-4 sm:gap-6">
                    <h2 className="max-w-[720px] text-2xl md:text-4xl font-bold leading-tight sm:leading-tight text-black font-display uppercase tracking-tight">
                        {title}
                    </h2>
                    <p className="text-sm max-w-[600px] font-medium text-[#D4AF37] uppercase tracking-widest">
                        {description}
                    </p>
                </div>
