    ...
    <section id="audit" className="py-24 px-6 bg-[#050505] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-5xl text-white font-bold mb-4">AI BRAND AUDITOR™</h2>
        ...
        <div className="bg-[#0a0a0a] border border-white/10 p-8 md:p-12 rounded-lg shadow-2xl relative min-h-[400px] flex flex-col justify-center">
          <AnimatePresence mode="wait">
            ...
            {step === 'intro' && (
              ...
              >
                <h3 className="text-2xl text-white font-bold mb-6">Prêt pour la vérité ?</h3>
              ...
              >
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-[#111] border border-white/10 p-4 text-white focus:border-[#D4AF37] outline-none transition-colors"
                ...
                <div className="pt-4">
                  <button 
                    type="submit"
                    className="w-full px-8 py-4 bg-transparent border border-[#D4AF37] text-[#D4AF37] font-bold uppercase tracking-widest hover:bg-[#D4AF37] hover:text-black transition-all flex items-center justify-center gap-2 group"
                  >
            ...
            {step === 'result' && (
              ...
              >
                <div className="mb-6 border-l-4 border-[#D4AF37] pl-6">
                  <h4 className="text-white font-bold text-xl mb-2">DIAGNOSTIC STRATÉGIQUE</h4>
                ...
                <div className="mt-8 flex flex-col md:flex-row gap-4">
                  <button className="flex-1 px-6 py-3 bg-[#D4AF37] text-black font-bold uppercase text-sm hover:bg-white transition-colors">
                    Réserver un appel stratégique
                  </button>
                  <button 
                    onClick={handleReset}
                    className="flex-1 px-6 py-3 bg-transparent border border-white/20 text-white font-bold uppercase text-sm hover:border-white transition-colors flex items-center justify-center gap-2"
                  >
                    <RefreshCcw size={16} />
                    Nouvelle Analyse
                  </button>
