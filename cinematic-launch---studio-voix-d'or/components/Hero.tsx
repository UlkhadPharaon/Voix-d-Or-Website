...
import { CONTENT, MOTION } from '../constants';
    ...
    <section id="hero" className="relative min-h-screen flex flex-col justify-center items-center text-center px-6 overflow-hidden bg-[#050505]">
      ...
      >
        ...
        <motion.h1 
          ...
          className="text-5xl md:text-8xl font-cinzel font-normal tracking-wide leading-[1.2] mb-10 text-white"
        >
        ...
        <motion.p 
          variants={MOTION.fadeUp}
          className="text-gray-400 text-base md:text-lg max-w-2xl mx-auto mb-16 font-light leading-8 tracking-wide"
        >
        ...
        <motion.div variants={MOTION.fadeUp}>
          <Magnetic>
            <button className="relative px-12 py-4 border border-[#D4AF37]/30 text-white hover:border-[#D4AF37] transition-all duration-700 group overflow-hidden">
                <span className="relative z-10 font-cinzel text-sm tracking-[0.2em] group-hover:text-black transition-colors duration-500">
                {CONTENT.hero.cta}
                </span>
